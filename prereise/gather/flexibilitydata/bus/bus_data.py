...
def get_all_bus_eiaid(bus_csv_path, cache_path, out_path):
    ...
    assert os.path.isfile(bus_csv_path), "Incorrect path for network data files bus.csv."
    assert os.path.isfile(cache_path + "/bus_fips.pkl"), "Cached file bus_fips.pkl does not exist."
    assert os.path.isfile(cache_path + "/bus_zip.pkl"), "Cached file bus_zip.pkl does not exist."
    assert os.path.isfile(cache_path + "/eiaid2fips.pkl"), "Cached file eiaid2fips.pkl does not exist."
