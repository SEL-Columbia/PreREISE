...
def aggregate_doe(root, out_path):
    ...
    for i in all_folders:
        ...
        eia_flex.at[eia_flex.index==file_flex.index, i] = file_flex['Flexibility'].values
        ...
        for c in all_csvs[1:]:
            ...
            if file_flex.shape[0] == eia_flex.shape[0]:
                ...
                eia_flex.loc[eia_flex.index.isin(pd.to_datetime(file_flex.index)), i] =  eia_flex.loc[eia_flex.index.isin(pd.to_datetime(file_flex.index)), i] + file_flex['Flexibility'].values
